 ...
 */
import { sendChatMessage as api_chat_send_sendChatMessage } from "~backend/chat/send";
...
export namespace chat {
    ...
    export class ServiceClient {
         ...
         */
        public async sendChatMessage(params: RequestType<typeof api_chat_send_sendChatMessage>): Promise<ResponseType<typeof api_chat_send_sendChatMessage>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/chat/send`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_chat_send_sendChatMessage>
        }
    }
}
...
export namespace session {
    ...
    export class ServiceClient {
         ...
         */
        public async createSession(params: RequestType<typeof api_session_create_createSession>): Promise<ResponseType<typeof api_session_create_createSession>> {
            // Now make the actual call to the API
        ...
        public async joinSession(params: RequestType<typeof api_session_join_joinSession>): Promise<ResponseType<typeof api_session_join_joinSession>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/sessions/join`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_session_join_joinSession>
        }
        ...
        public async leaveSession(params: { sessionId: string }): Promise<ResponseType<typeof api_session_leave_leaveSession>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/sessions/${encodeURIComponent(params.sessionId)}/leave`, {method: "POST", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_session_leave_leaveSession>
        }

        /**
         * Lists sessions the user owns or participates in.
         */
        public async listMySessions(): Promise<ResponseType<typeof api_session_list_listMySessions>> {
            // Now make the actual call to the API
         ...
         */
        public async terminateSession(params: { sessionId: string }): Promise<ResponseType<typeof api_session_terminate_terminateSession>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/sessions/${encodeURIComponent(params.sessionId)}/terminate`, {method: "POST", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_session_terminate_terminateSession>
        }
    }
}
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { publishSignal as api_signaling_publish_publishSignal } from "~backend/signaling/publish";
...
export namespace signaling {
    ...
    export class ServiceClient {
         ...
         */
        public async publishSignal(params: RequestType<typeof api_signaling_publish_publishSignal>): Promise<ResponseType<typeof api_signaling_publish_publishSignal>> {
            // Now make the actual call to the API
