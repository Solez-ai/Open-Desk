...
```bash
git remote add encore encore://opendesk-backend-supabase-ohbi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/opendesk-backend-supabase-ohbi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/opendesk-backend-supabase-ohbi/settings/integrations/github)
